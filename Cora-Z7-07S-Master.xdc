...
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports ps2_data]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports ps2_clk]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports scl]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports sda]
set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { tx }]; #IO_L13P_T2_MRCC_34 Sch=ck_io[8]
